...
export default function MultiStepForm({ onComplete }) {
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto">
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-center text-gray-800">Step {step} of 6</h2>
            ...
            {step === 6 && (
                <div>
                    <label className="block text-gray-700 mb-2 text-lg">Is there anything else you'd like us to know about your project?</label>
                    <textarea 
                        name="additionalInfo" 
                        ...
                        className="border border-gray-300 p-3 rounded-lg w-full focus:outline-none focus:border-blue-500 mb-4" 
                        rows="4"
                        placeholder="Share any additional requirements, preferences, or context that might be helpful"
                    ></textarea>
                    <div className="flex justify-between">
                        <button onClick={handlePrev} className="btn-secondary">Previous</button>
